...
public class CommentServiceImpl implements CommentService {
  @Override
  public Comments getComments(Integer limit, Integer offset, SortOrderEnum sortOrder) {
    return null;
  }

  @Override
  public CommentPostResponse postComment(CommentPostRequest commentPostRequest) {
    return null;
  }
}

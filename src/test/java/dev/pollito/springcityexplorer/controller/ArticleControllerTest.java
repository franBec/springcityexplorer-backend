...
class ArticleControllerTest {
    ...
    void whenGetArticlesByCountryThenReturnsArticles(){
        ...
        when(articleService.getArticlesByCountry(anyString(),anyInt(), anyInt())).thenReturn(expectedResponse.getBody());

        ResponseEntity<Articles> actualResponse = articleController.getArticlesByCountry(MOCK_STRING, MOCK_INTEGER, MOCK_INTEGER);
